package com.pudao.android.popup;
...
public class AddPupupWindow extends PopupWindow {

    public AddPupupWindow(final Activity context, int resId, final OnItemClickListener onItemClickListener) {
